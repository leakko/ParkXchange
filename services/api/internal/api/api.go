...
func (a *API) Handler() http.Handler {
	...
	mux.Handle("POST /v1/reservations/{id}/clear-driver-arrived", a.requireAuth(a.handleClearDriverArrived))
	mux.Handle("POST /v1/reservations/{id}/driver-ready", a.requireAuth(a.handleDriverReady))
	mux.Handle("POST /v1/reservations/{id}/driver-confirm-entered", a.requireAuth(a.handleDriverConfirmEntered))
	mux.Handle("POST /v1/reservations/{id}/driver-report-owner-no-show", a.requireAuth(a.handleDriverReportOwnerNoShow))
